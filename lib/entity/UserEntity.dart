 ...
 * @author:xuwh
 * @date:2019/12/22 0022 19:44
 * @UpdateUser： 更新者
 * @UpdateDate:     2019/12/22 0022 19:44
 * @UpdateRemark:   更新说明
 * @version:
 */
class UserEntity {
...
class UserData {
  ...
  UserData(this.password, this.chapterTops, this.icon, this.admin,
      this.collectIds, this.id, this.type, this.email, this.token,
      this.username);
