 ...
 * @author:xuwh
 * @date:2020/1/26 0026 15:38
 * @UpdateUser： 更新者
 * @UpdateDate:     2020/1/26 0026 15:38
 * @UpdateRemark:   更新说明
 * @version:
 */
class FriendsDynamicEntity {
  ...
  static FriendsDynamicEntity fromMap(Map<String, dynamic> map) {
    FriendsDynamicEntity friends_dynamic = FriendsDynamicEntity();
  ...
  static List<FriendsDynamicEntity> fromMapList(dynamic mapList) {
    List<FriendsDynamicEntity> list = List(mapList.length);
